...
function CardCat({src,title,id}) {
  return (
    ...
    <Card className='hover:-translate-y-6 duration-500  mb-10  w-40 ' imgSrc={src} >
    <h5 className=" text-base text-center font-bold font-oleo tracking-tight text-gray-900 dark:text-white">
    {title}
    </h5>
